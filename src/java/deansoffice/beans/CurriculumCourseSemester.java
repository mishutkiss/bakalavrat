...
public class CurriculumCourseSemester extends IntKeyEntity implements Serializable {
...
//        this.id = id;
//    }
    public CurriculumCourseSemester(short semester, BigDecimal hoursPerWeek) {
//        this.id = id;
...
//    }
    ...
    public String toString() {
        return "deansoffice.beans.CurriculumCourseSemester[ id=" + id + " ]";
    }
}
